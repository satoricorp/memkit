...
| Document | Purpose |
|----------|---------|
| [../README.md](../README.md) | Build, quick start, commands |
...
Authoritative CLI and API notes live in the repo root and `specs/` “current” files. Legacy RFCs and pre-Helix drafts are under [`specs/legacy/`](../specs/legacy/).
